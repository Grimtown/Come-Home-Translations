...
translate spanish strings:
    ...
    new "La lectura en voz alta automática está desactivada."

    # renpy/common/00accessibility.rpy:29
    old "Clipboard voicing enabled. "
    new "La lectura en voz alta del portapapeles está activada. "

    # renpy/common/00accessibility.rpy:30
    old "Self-voicing enabled. "
    new "La lectura en voz alta automática está activada. "
    ...
    old "Self-Voicing"
    new "Lectura en voz alta automática"

    # renpy/common/00accessibility.rpy:137
    old "Self-voicing support is limited when using a touch screen."
    new "La compatibilidad con la lectura en voz alta automática es limitada cuando se utiliza una pantalla táctil."
    ...
    new "Reducción del volumen de la voz automática"
    ...
    new "Menú de accesibilidad. Utiliza las flechas arriba y abajo para navegar, y pulsa Intro para activar botones y barras."
    ...
    new "Haz clic para activar el atributo; haz clic con el botón derecho para activar el atributo negativo."
    ...
    new "Haz clic para establecer la transformación; haz clic con el botón derecho para añadirla a la lista de transformaciones."
    ...
    new "Haz clic para establecerlo; haz clic con el botón derecho para añadirlo a la lista de «detrás»."
    ...
    old "Click to set."
    new "Haz clic para establecerla."
    ...
    new "¿Estás seguro de que quieres empezar a saltarte partes?"
    ...
    new "¿Estás seguro de que quieres saltarte los diálogos que no has visto y pasar a la siguiente opción?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Esta partida guardada se creó en otro dispositivo. Los archivos de partida guardada creados con fines maliciosos pueden dañar tu ordenador. ¿Confías en el creador de esta partida guardada y en todas las personas que podrían haber modificado el archivo?"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "¿Confías en el dispositivo en el que se creó la partida guardada? Solo debes elegir «Sí» si eres el único usuario del dispositivo."
    ...
    new "Este programa contiene software libre bajo varias licencias, incluidas la Licencia MIT y la Licencia Pública General Reducida de GNU. Puedes encontrar una lista completa del software, incluidos enlaces al código fuente completo, {a=https://www.renpy.org/l/license}aquí{/a}."
    ...
    new "avance automático tras clic"

    # renpy/common/00preferences.rpy:415
    old "automatic move"
    new "desplazamiento automático"
    ...
    new "activar voz propia"

    # renpy/common/00preferences.rpy:447
    old "self voicing disable"
    new "desactivar voz propia"

    # renpy/common/00preferences.rpy:451
    old "self voicing volume drop"
    new "reducción de volumen de voz propia"
    ...
    new "Voz del portapapeles activada. Pulsa «Shift+C» para desactivarla."

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "La voz automática diría «[renpy.display.tts.last]». Pulsa «Alt+Shift+V» para desactivarla."
    ...
    new "(borrar bocadillos guardados)"
    ...
    new "No se pudo conectar al servidor de sincronización de Ren'Py."

    # renpy/common/00sync.rpy:186
    old "The Ren'Py Sync server timed out."
    new "El servidor de sincronización de Ren'Py agotó el tiempo de espera."

    # renpy/common/00sync.rpy:188
    old "An unknown error occurred while connecting to the Ren'Py Sync server."
    new "Se produjo un error desconocido al conectarse al servidor de sincronización de Ren'Py."

    # renpy/common/00sync.rpy:204
    old "The Ren'Py Sync server does not have a copy of this sync. The sync ID may be invalid, or it may have timed out."
    new "El servidor de sincronización de Ren'Py no tiene una copia de esta sincronización. Es posible que el ID de sincronización no sea válido o que haya agotado el tiempo de espera."
    ...
    new "Esto se conectará con el {a=https://sync.renpy.org}Servidor de sincronización de Ren'Py{/a}."

    # renpy/common/00sync.rpy:498
    old "Sync Success"
    new "Sincronización correcta"
    ...
    new "O bien este proyecto no admite actualizaciones, o bien se ha eliminado el archivo de estado de actualización."
    ...
    new "[u.version] está disponible. ¿Deseas instalarlo?"
    ...
    new "Las actualizaciones se han cancelado."
    ...
    new "Habilitar (sin lista de bloqueados)"
    ...
    new "Este ordenador tiene un problema para mostrar los gráficos: [problem]."

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Es posible que sus controladores gráficos estén desactualizados o no funcionen correctamente. Esto puede provocar una visualización de gráficos lenta o incorrecta."

    # renpy/common/00gltest.rpy:224
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información que te ayude a determinar qué le pasa a tu ordenador."

    # renpy/common/00gltest.rpy:229
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "Encontrarás más detalles sobre cómo solucionar esto en la {a=[url]}documentación{/a}."
    ...
    new "Intenta revertir a un momento anterior, lo que te permite guardar o elegir una opción diferente."
    ...
    new "Ignora la excepción, lo que te permite continuar."

    # renpy/common/_errorhandling.rpym:840
    old "Ignores the exception, allowing you to continue. This often leads to additional errors."
    new "Ignora la excepción, lo que te permite continuar. Esto suele provocar errores adicionales."
