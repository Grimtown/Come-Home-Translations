...
translate chinese strings:
    ...
    new "辅助功能菜单。使用上下箭头键进行导航，按回车键激活按钮和控件。"
    ...
    new "此菜单中的选项旨在提升无障碍体验。它们可能无法与所有游戏兼容，且某些选项组合可能会导致游戏无法运行。这并非游戏或引擎本身的问题。为获得最佳效果，在更改字体时请尽量保持文本大小与原始设置一致。"
    ...
    new "您确定要跳过未读对话并直接跳至下一个选项吗？"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "此存档是在另一台设备上创建的。恶意构造的存档文件可能会损害您的计算机。您是否信任此存档的创建者以及所有可能修改过该文件的人？"

    # renpy/common/00gui.rpy:460
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "您是否信任创建此存档的设备？仅当您是该设备的唯一用户时，才应选择“是”。"
    ...
    new "本程序包含多种许可协议下的免费软件，包括 MIT 许可协议和 GNU 较少通用公共许可证。 完整的软件列表（含完整源代码链接）可查阅{a=https://www.renpy.org/l/license}此处{/a}。"
    ...
    new "剪贴板语音功能已启用。按 'shift+C' 禁用。"

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自动语音会说 \"[renpy.display.tts.last]\"。按 'alt+shift+V' 禁用。"
    ...
    new "Ren'Py 同步服务器上没有此同步的副本。同步 ID 可能无效，或者已超时。"
    ...
    new "这将连接到 {a=https://sync.renpy.org}Ren'Py 同步服务器{/a}。"
    ...
    new "翻译为 [tl.filename]:[tl.linenumber]"
    ...
    new "这台计算机存在图形显示问题：[problem]。"

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "其图形驱动程序可能已过时或运行异常。这可能会导致图形显示缓慢或不正确。"

    # renpy/common/00gltest.rpy:224
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a}文件中可能包含有助于您确定计算机问题的信息。"
    ...
    new "将 traceback.txt 文件作为 Markdown 格式复制到剪贴板，适用于 Discord。"
    ...
    new "从磁盘重新加载游戏，并在可能的情况下保存并恢复游戏状态。"
